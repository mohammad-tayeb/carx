            ...
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    ...
                    >
                        <Image
                            ...
                            width={120}
                            height={120}
                            alt="AutoGallery Logo"
                            className="md:max-w-lg max-w-sm"
                        />
                    </a>
                    <div className="mt-6 lg:max-w-sm">
                        <p className="text-sm text-gray-800">
                            At AutoGallery, we bring you a curated collection of the latest and finest vehicles from top global manufacturers.
                        </p>
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <div className="flex">
                        ...
                        <a
                            href="mailto:support@autogallery.com"
                            aria-label="Our email"
                            title="Our email"
                            className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
                        >
                            support@autogallery.com
                        </a>
                    </div>
                    <div className="flex">
                ...
                <div>
                    ...
                    <p className="mt-4 text-sm text-gray-500">
                        Stay updated with the latest car releases, reviews, and events from AutoGallery.
                    </p>
                </div>
            </div>
